...
public class LoginController {
	...
	public ModelAndView Cadastrar(@Valid RequestCadastro req) {
		...
		Usuario UsernameExist = this.repositoryUser.findByUsername(req.getNome());
		Usuario EmailExist =  this.repositoryUser.findByEmail(req.getEmail());
		...
		usuario.setPassword(this.passwordEncoder.encode(String.valueOf(senha)));
	...
	public ModelAndView forget() {
		System.out.println("vc entrou aqui");
	...
	public ModelAndView retrieve(@RequestParam String email) {
		...
		if(usuario == null) {
			ModelAndView mv = new ModelAndView("Autenticacao/forgetPassword.html");
