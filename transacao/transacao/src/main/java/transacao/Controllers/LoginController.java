...
public class LoginController {
	...
	public ModelAndView Cadastrar(@Valid RequestCadastro req) {
		...
		Usuario usuario = Usuario.generatedUser(req.getNome(), req.getEmail(), String.valueOf(Senha.autoGenerated(6)), passwordEncoder);
    ...
    Authentication authentication) {
		...
		List<Usuario> usuarios = this.repositoryUser.findAllWithoutPatternAndLoggedAndOnlyAtive(authentication.getName());
	...
	public ModelAndView retrieve(@RequestParam String email) {
		...
		System.out.println("vc recebeu um email: " + email);
		
		String senha = String.valueOf(Senha.autoGenerated(6));
	
		Usuario usuario = this.repositoryUser.findByEmailInAtive(email);
